...
import com.wang.mykitchenapp.activity.DishCreateDishActivity;
...
public class DishFragment extends BaseFragment {
    ...
    private void initFab(View view){
        ...
        mFab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), DishCreateDishActivity.class);
    ...
    public void refresh(){
        ...
        String url = Constant.BASE_URL + "dish/getDishs.do";
        //网络请求
        mCompositeSubscription.add(mDataManager.postData(url, map)
                ...
                .subscribe(new Observer<JsonObject>() {
                    ...
                    public void onCompleted() {
                        ...
                        dishListAdapter.refreshList(dishOverviewList);
                    }
                    @Override
