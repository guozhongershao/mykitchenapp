...
public class BBSExperienceFragment extends BaseFragment {
    private final String TAG ="BBSExperienceFragment";
        ...
        mCompositeSubscription.add(mDataManager.postData(url, map)
                ...
                .subscribe(new Observer<JsonObject>() {
                               ...
                               public void onNext(JsonObject jsonObject) {
                                   ...
                                   mBbsNotes = gson.fromJson(mReturnedJsonObject.get("BbsNotes"),new TypeToken<List<BbsNote>>(){}.getType());
                                   if(mBbsNotes != null)
                                       System.out.println("mBbsNotes is not null");
