...
public class DishStepsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener{
    ...
    public DishStepsAdapter(Context context,List<Dish.StepsBean> steps) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        //强制转换
        DishStepsAdapter.DishStepHolder stepHolder = (DishStepsAdapter.DishStepHolder) holder;
        try {
            attachmentUrl = Constant.BASE_URL_IMAGES + dishStep.getDistAttachmenturl();
        }catch (Exception e){
            e.printStackTrace();
        }
        ...
        Glide.with(context).load(attachmentUrl).into(stepHolder.mIvAttachment);
    }
